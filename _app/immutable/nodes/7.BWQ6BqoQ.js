import"../chunks/UB_A2OAH.js";import{i as R}from"../chunks/BB5NvG_g.js";import{p as A,o as L,d as q,f as u,t as J,a as r,b as k,h as s,c as l,g as c,n as i,r as v}from"../chunks/DsMxK9eM.js";import{s as I}from"../chunks/DM644vHB.js";import{b as V}from"../chunks/BH2k4log.js";import{C as p}from"../chunks/BGxjbqs5.js";import{C as f}from"../chunks/CbjFnfXq.js";import{P as Y}from"../chunks/D-oM4OBp.js";import{z as D,T as d}from"../chunks/oLK4B4FJ.js";var E=u('<div slot="right" class="result-panel svelte-1bguwvm"><div id="test-container-1" class="svelte-1bguwvm"><div class="test-box svelte-1bguwvm" id="box-1">#box-1</div></div></div>'),H=u('<div slot="right" class="result-panel svelte-1bguwvm"><div id="test-container-2" class="svelte-1bguwvm"><div class="test-box svelte-1bguwvm" id="box-2">#box-2</div></div></div>'),M=u('<div slot="right" class="result-panel svelte-1bguwvm"><div id="test-container-3" class="svelte-1bguwvm"><div class="test-box svelte-1bguwvm" id="box-3">#box-3</div></div></div>'),U=u(`<section class="doc-section svelte-1bguwvm"><h1 id="responsive-pointers" class="svelte-1bguwvm">Responsive pointers</h1> <p class="svelte-1bguwvm">You can configure how the free pointers (including arrows) behave when container sizes change.</p> <!> <p class="svelte-1bguwvm">Please note that this requires updating. When the window size changes, a 
...
// Rest of the previous example code`,r(t,o)},$$slots:{default:!0}})},right:(e,n)=>{var t=H();r(e,t)}}});var T=s(y,4);f(T,{$$slots:{left:(e,n)=>{p(e,{slot:"left",language:"JavaScript",showLanguage:!1,noTop:!0,children:(t,_)=>{i();var o=c();o.nodeValue=`const baseOptions = {
  target: '#box-3', 
...
// Rest of the previous example code`,r(t,o)},$$slots:{default:!0}})},right:(e,n)=>{var t=M();r(e,t)}}}),v(x),v(m),J(()=>I(C,"href",`${V??""}/config#configuring-global-options`)),r(P,m),k()}export{Z as component};
