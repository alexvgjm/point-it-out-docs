import"../chunks/UB_A2OAH.js";import{i as I}from"../chunks/BB5NvG_g.js";import{p as L,o as N,d as V,f as s,e as B,t as j,a as o,b as J,g as c,h as a,c as l,n,r as d}from"../chunks/DsMxK9eM.js";import{s as M}from"../chunks/DM644vHB.js";import{C as u}from"../chunks/BGxjbqs5.js";import{C as g}from"../chunks/CbjFnfXq.js";import{P as W}from"../chunks/D-oM4OBp.js";import{j as y,B as z}from"../chunks/BV06dsaN.js";import{b as F}from"../chunks/C3U4DfaE.js";import{I as H}from"../chunks/j7q8YR3o.js";var U=s('<div slot="right" class="result-panel"><div class="test-box" id="box-1">#box-1</div></div>'),Y=s('<div slot="right" class="result-panel"><div class="test-box" id="box-2">#box-2</div></div>'),q=s('<div slot="left"><!> <!></div>'),E=s('<div slot="right" class="result-panel"><div class="test-box" id="example">#example</div></div>'),G=s("Do not mix <code>animate</code> option and custom animations.",1),K=s(`<section class="doc-section"><h1 id="animate">Pointer animations</h1> <p>As of version 0.1.14, Point it out includes some basic, ready-to-use animations.</p> <p>Some pointers (currently all) support an <code>animate</code> option.
  ...
  one of the reasons for its existence.</p></section>`,1);function re(P,T){L(T,!1),N(()=>{y("rect",{target:"#box-1",container:"main",animate:{name:"pulse",duration:.75}}),y("rect",{target:"#example",container:"main",className:"my-spinny-pointer"}),y("arrow",{target:"#box-2",container:"main",animate:"pulse",distance:30,fromAngle:"right top"})}),V(z);const C=[{property:"name",types:["'pulse'"],description:"Only 'pulse' available. There will be more in future releases."},{property:"duration",types:["number"],default:"1",description:"Duration of an animation cycle. The higher this number, the lower the speed."},{property:"direction",types:["'normal'","'alternate'"],default:"'alternate'",description:"If should play forward or alternate forward and backward."},{property:"repeat",types:["number","'infinite'"],default:"'infinite'",description:"Number of repetitions or 'infinite'"}];I();var b=K(),h=B(b),$=a(l(h),6);g($,{$$slots:{left:(t,r)=>{u(t,{slot:"left",language:"TypeScript",showLanguage:!1,noTop:!0,children:(e,m)=>{n();var i=c();i.nodeValue=`create('rect', {
    ...
    fromAngle: 'right top',
    animate: 'pulse',
})`,o(e,i)},$$slots:{default:!0}})},right:(t,r)=>{var e=Y();o(t,e)}}});var k=a(w,4);W(k,{title:"AnimationOptions",get pioOptionsList(){return C}}),n(4),d(h);var x=a(h,2),f=a(l(x),4),_=a(l(f)),A=l(_);d(_),n(),d(f);var S=a(f,2);g(S,{margin:"2.5rem",$$slots:{left:(t,r)=>{var e=q(),m=l(e);u(m,{language:"JavaScript",noTop:!0,children:(v,D)=>{n();var p=c();p.nodeValue=`create('rect', {
  target: '#example', 
  container: 'main',
...
}`,o(v,p)},$$slots:{default:!0}}),d(e),o(t,e)},right:(t,r)=>{var e=E();o(t,e)}}});var O=a(S,2);H(O,{title:"",children:(t,r)=>{n();var e=G();n(2),o(t,e)},$$slots:{default:!0}}),n(8),d(x),j(()=>M(A,"href",`${F??""}/create#common-params`)),o(P,b),J()}export{re as component};
