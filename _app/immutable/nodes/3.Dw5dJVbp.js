import{a as o,t as s,d as c}from"../chunks/disclose-version.DjlcKni_.js";import{i as I}from"../chunks/legacy.BQXG6iyP.js";import{p as L,o as N,b as V,f as B,a as J,s as a,c as l,n as i,r as d}from"../chunks/index-client.C_AGn1Ij.js";import{s as M}from"../chunks/general.svelte.B65VZ__f.js";import{C as u}from"../chunks/Code.DUo6Pgyj.js";import{C as g}from"../chunks/ColumnsContainer.DbzHa6Fa.js";import{P as W}from"../chunks/PropertiesTable.Cw4P0USA.js";import{Y as y,Z as Y}from"../chunks/pointitout.Jpb47ULF.js";import{b as j}from"../chunks/paths.CXGXOoeF.js";import{I as z}from"../chunks/InfoBox.D6dvsujv.js";var F=s('<div slot="right" class="result-panel"><div class="test-box" id="box-1">#box-1</div></div>'),H=s('<div slot="right" class="result-panel"><div class="test-box" id="box-2">#box-2</div></div>'),U=s('<div slot="left"><!> <!></div>'),Z=s('<div slot="right" class="result-panel"><div class="test-box" id="example">#example</div></div>'),q=s("Do not mix <code>animate</code> option and custom animations.",1),E=s(`<section class="doc-section"><h1 id="animate">Pointer animations</h1> <p>As of version 0.1.14, Point it out includes some basic, ready-to-use animations.</p> <p>Some pointers (currently all) support an <code>animate</code> option.
  ...
  one of the reasons for its existence.</p></section>`,1);function ne(P,T){L(T,!1),N(()=>{y("rect",{target:"#box-1",container:"main",animate:{name:"pulse",duration:.75}}),y("rect",{target:"#example",container:"main",className:"my-spinny-pointer"}),y("arrow",{target:"#box-2",container:"main",animate:"pulse",distance:30,fromAngle:"top-right"})}),V(Y);const C=[{property:"name",types:["'pulse'"],description:"Only 'pulse' available. There will be more in future releases."},{property:"duration",types:["number"],default:"1",description:"Duration of an animation cycle. The higher this number, the lower the speed."},{property:"direction",types:["'normal'","'alternate'"],default:"'alternate'",description:"If should play forward or alternate forward and backward."},{property:"repeat",types:["number","'infinite'"],default:"'infinite'",description:"Number of repetitions or 'infinite'"}];I();var $=E(),h=B($),b=a(l(h),6);g(b,{$$slots:{left:(t,r)=>{u(t,{slot:"left",language:"TypeScript",showLanguage:!1,noTop:!0,children:(e,m)=>{i();var n=c();n.nodeValue=`create('rect', {
    target: '#box-1', 
    container: 'main',
    animate: {
        name: 'pulse',
...
})`,o(e,n)},$$slots:{default:!0}})},right:(t,r)=>{var e=F();o(t,e)}}});var w=a(b,2);g(w,{$$slots:{left:(t,r)=>{u(t,{slot:"left",language:"TypeScript",showLanguage:!1,noTop:!0,children:(e,m)=>{i();var n=c();n.nodeValue=`create('arrow', {
    target: '#box-2', 
    container: 'main',
    distance: 30,
    fromAngle: 'top-right',
    animate: 'pulse',
})`,o(e,n)},$$slots:{default:!0}})},right:(t,r)=>{var e=H();o(t,e)}}});var k=a(w,4);W(k,{title:"AnimationOptions",pioOptionsList:C}),i(4),d(h);var x=a(h,2),f=a(l(x),4),_=a(l(f)),A=l(_);M(A,"href",`${j??""}/create#common-params`),d(_),i(),d(f);var S=a(f,2);g(S,{margin:"2.5rem",$$slots:{left:(t,r)=>{var e=U(),m=l(e);u(m,{language:"JavaScript",noTop:!0,children:(v,D)=>{i();var p=c();p.nodeValue=`create('rect', {
  target: '#example', 
  container: 'main',
...
}`,o(v,p)},$$slots:{default:!0}}),d(e),o(t,e)},right:(t,r)=>{var e=Z();o(t,e)}}});var O=a(S,2);z(O,{title:"",children:(t,r)=>{i();var e=q();i(2),o(t,e)},$$slots:{default:!0}}),i(8),d(x),o(P,$),J()}export{ne as component};
